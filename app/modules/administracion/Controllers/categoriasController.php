...
class Administracion_categoriasController extends Administracion_mainController
{
	...
	public function indexAction()
	{
		...
		// $filters = $filters . " AND categoria_padre = 0 ";
		// echo $filters ;
		$order = "orden ASC";
	...
	public function manageAction()
	{
		...
		$this->_view->csrf_section = $this->_csrf_section;
		$this->_view->csrf = Session::getInstance()->get('csrf')[$this->_csrf_section];
		$this->_view->list_categoria_padre = $this->getCategoriapadre();
	...
	private function getData()
	{
		...
		$data['categoria_padre'] = $this->_getSanitizedParam("categoria_padre");
	...
	/**
	 * Genera los valores del campo Padre.
	 *
	 * @return array cadena con los valores del campo Padre.
	 */
	private function getCategoriapadre()
	{
	...
	protected function getFilter()
	{
		...
		$padre = $this->_getSanitizedParam("padre");
		if ($padre != '') {
			$filtros = $filtros . " AND categoria_padre = '" . $padre . "' ";
			$this->_view->padre = $padre;
		} else {
			$filtros = $filtros . " AND categoria_padre = 0 ";
		}
	...
	protected function filters()
	{
		if ($this->getRequest()->isPost() == true) {
			...
			$parramsfilter['categoria_imagen'] = $this->_getSanitizedParam("categoria_imagen");
