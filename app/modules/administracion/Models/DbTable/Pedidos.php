...
class Administracion_Model_DbTable_Pedidos extends Db_Table
{
	...
	public function insert($data){
		...
		$query = "INSERT INTO pedidos( pedido_documento, pedido_nombre, pedido_correo, pedido_celular, pedido_propina, pedido_fecha, pedido_valorpagar, pedido_estado, pedido_estado_texto, pedido_estado_texto2, pedido_cus, pedido_franquicia, pedido_medio, pedido_nombrefe, pedido_correofe, pedido_celularfe, pedido_cuotas, pedido_request_id, pedido_ip, pedido_numeroaccion, pedido_observacion, pedido_lugar, pedido_estado_preparacion, pedido_estado_preparacion_text) VALUES ( '$pedido_documento', '$pedido_nombre', '$pedido_correo', '$pedido_celular', '$pedido_propina', '$pedido_fecha', '$pedido_valorpagar', '$pedido_estado', '$pedido_estado_texto', '$pedido_estado_texto2', '$pedido_cus', '$pedido_franquicia', '$pedido_medio', '$pedido_nombrefe', '$pedido_correofe', '$pedido_celularfe', '$pedido_cuotas', '$pedido_request_id', '$pedido_ip', '$pedido_numeroaccion', '$pedido_observacion', '$pedido_lugar', '$pedido_estado_preparacion', '$pedido_estado_preparacion_text')";
