        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="impuesto_estado" value="<?php echo $this->getObjectVariable($this->filters, 'impuesto_estado') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Nombre</label>
		            ...
		            <input type="text" class="form-control" name="impuesto_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'impuesto_nombre') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="impuesto_porcentaje" value="<?php echo $this->getObjectVariable($this->filters, 'impuesto_porcentaje') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->impuesto_id; ?>
					<tr>
						<td><?=$content->impuesto_estado;?></td>
						<td><?=$content->impuesto_nombre;?></td>
						<td><?=$content->impuesto_porcentaje;?></td>
						<td>
