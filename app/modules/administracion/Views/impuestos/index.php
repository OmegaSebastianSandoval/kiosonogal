			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="impuesto_estado"
							value="<?php echo $this->getObjectVariable($this->filters, 'impuesto_estado') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Nombre</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="impuesto_nombre"
							value="<?php echo $this->getObjectVariable($this->filters, 'impuesto_nombre') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="impuesto_porcentaje"
							value="<?php echo $this->getObjectVariable($this->filters, 'impuesto_porcentaje') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
