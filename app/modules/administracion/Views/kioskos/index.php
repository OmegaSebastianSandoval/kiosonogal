        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="kiosko_codigo" value="<?php echo $this->getObjectVariable($this->filters, 'kiosko_codigo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Estado</label>
		            ...
		            <input type="text" class="form-control" name="kiosko_estado" value="<?php echo $this->getObjectVariable($this->filters, 'kiosko_estado') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="kiosko_localizacion" value="<?php echo $this->getObjectVariable($this->filters, 'kiosko_localizacion') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="kiosko_fecha_activacion" value="<?php echo $this->getObjectVariable($this->filters, 'kiosko_fecha_activacion') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->kiosko_id; ?>
					<tr>
						<td><?=$content->kiosko_codigo;?></td>
						<td><?=$content->kiosko_estado;?></td>
						<td><?=$content->kiosko_localizacion;?></td>
						<td><?=$content->kiosko_fecha_activacion;?></td>
						<td class="text-end">
							<div>
