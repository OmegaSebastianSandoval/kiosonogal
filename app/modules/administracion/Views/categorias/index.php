...
<div class="container-fluid">
	<?php if ($this->padre) { ?>
		<a class="btn btn-azul mt-4" href="<?= $this->route ?>">Volver</a>
	<?php } ?>
			...
			<div class="row">
				<div class="col-6">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="categoria_nombre"
							value="<?php echo $this->getObjectVariable($this->filters, 'categoria_nombre') ?>"></input>
					</label>
				</div>
				<div class="col-3 d-none">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="categoria_imagen"
							value="<?php echo $this->getObjectVariable($this->filters, 'categoria_imagen') ?>"></input>
					</label>
				</div>
				<div class="col-3 d-none">
					<label>Estado</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="categoria_estado"
							value="<?php echo $this->getObjectVariable($this->filters, 'categoria_estado') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
			...
			<div class="row">
				...
				<div class="col-3">
					<div class="text-end"><a class="btn btn-sm btn-success"
							href="<?php echo $this->route . "/manage?padre=" . $this->padre; ?>"> <i class="fas fa-plus-square"></i>
							Crear Nuevo</a></div>
				</div>
			</div>
		</div>
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							...
							<td><?= $content->categoria_estado == 1 ? 'Activa' : 'Inactiva'; ?></td>
							<td>
								...
								<div>
									<?php if ($content->categoria_padre == 0 || !$content->categoria_padre) { ?>
										<!-- <a class="btn btn-rosado btn-sm" href="<?php echo $this->route; ?>/?padre=<?= $id ?>"
											data-bs-toggle="tooltip" data-placement="top" title="Subcategorias"><i class="fas fa-plus"></i></a> -->
									<?php } ?>

									<a class="btn btn-azul btn-sm"
										href="<?php echo $this->route; ?>/manage?id=<?= $id ?>&padre=<?= $content->categoria_padre ?>"
