			...
			<div class="row">
				<div class="col-2">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="producto_nombre"
							value="<?php echo $this->getObjectVariable($this->filters, 'producto_nombre') ?>"></input>
					</label>
				</div>
				<div class="col-2 d-none">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="producto_imagen"
							value="<?php echo $this->getObjectVariable($this->filters, 'producto_imagen') ?>"></input>
					</label>
				</div>
				<div class="col-2 d-none">
					<label>Precio</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="producto_precio"
							value="<?php echo $this->getObjectVariable($this->filters, 'producto_precio') ?>"></input>
					</label>
				</div>
				<div class="col-2 d-none">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="producto_cantidad"
							value="<?php echo $this->getObjectVariable($this->filters, 'producto_cantidad') ?>"></input>
					</label>
				</div>
				<div class="col-2">
				...
				<div class="col-2">
					...
					<label class="input-group">
						...
						<select class="form-control" name="producto_subcategoria">
							<option value="">Todas</option>
							<?php foreach ($this->list_producto_subcategoria as $key => $value): ?>
								<option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'producto_subcategoria') == $key) {
										echo "selected";
									} ?>><?= $value; ?></option>
							<?php endforeach ?>
						</select>
				...
				<div class="col-2 d-none">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="producto_estado"
							value="<?php echo $this->getObjectVariable($this->filters, 'producto_estado') ?>"></input>
					</label>
				</div>
				<div class="col-2">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="producto_codigo"
							value="<?php echo $this->getObjectVariable($this->filters, 'producto_codigo') ?>"></input>
					</label>
				</div>
				<div class="col-2">
					<label>&nbsp;</label>
